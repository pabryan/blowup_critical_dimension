...
Let us first consider the case \(C = 1\) which is satisfied in critical dimension. We make the ansatz,
\[
\xi(r, t) = \xi_0(r^{\beta})
\]
for some function \(\xi_0\) with \(\xi_0(0) = 0\) and some real number \(\beta > 0\).
