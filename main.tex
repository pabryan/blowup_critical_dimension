...
\textbf{We now need a contraction mapping to assert the existence of an inverse}.

\textbf{We also need to determine how the solutions vary with respect to the free parameters which is needed for barrier construction}.

\textbf{Work out asymptotics as \(r\to 0\) which is important for barrier construction}.
